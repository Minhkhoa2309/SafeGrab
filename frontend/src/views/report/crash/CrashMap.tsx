...
import { fetchDataMap } from 'src/store/crashes';
...
const CrashMap = ({ startDate, endDate, streetName }: filterProps) => {
    ...
    }, [dispatch, startDate, endDate, streetName, mapZoom, mapBounds, map]);
